...
|---:|---|
| 1–2 | Normal Pearl, score, star, move limit, result/save |
| 3–4 | `x2_score` แบบ temporary 3 ตา |
| 5–6 | `bomb_pearl` ระเบิดบนบอร์ด |
| 7–8 | `bomb_item` เป็น item ฝั่งผู้เล่น |
| 9–10 | `stone_pearl` และ fish helper บินชนลูกบอลสุ่ม 2 ลูก |
| 11–13 | `clear_specific_color` เป้าหมายเฉพาะสี |
| 14–15 | `extra_moves_2` เพิ่มลูกยิง 2 ลูก |
| 16–21 | `rocket_item` และเริ่มผสม obstacle เดิม |
| 22–28 | `metal_barrier`, board drop แบบเบา ๆ, new row spawn |
| 29–30 | Boss Fight แรก |
| 31–35 | เพิ่มความซับซ้อนของ board drop และ `locked_pearl` |
| 36–40 | `fire_beam` และด่านผสม locked/stone/bomb |
| 41–45 | `color_change` และ `color_spread_pearl` |
| 46–50 | `color_clear` และด่านเป้าหมายสีแบบซับซ้อนขึ้น |
| 51–70 | `vine_pearl`, `dual_color_pearl`, `fog_pearl` |
| 71–90 | `balloon_anchor`, `spike_pearl` |
| 91–120 | `moving_panel`, board pattern ซับซ้อนขึ้น |
| 121–150 | `rotating_panel`, obstacle mix, boss variation |
| 151–180 | ด่าน challenge ผสมหลาย mechanic แต่ยังอ่านง่าย |
| 181–200 | Master stages, boss finale, mechanic mix แบบคัดสรร |

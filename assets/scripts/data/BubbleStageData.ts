...
export const BUBBLE_STAGE_CONFIGS: BubbleStageConfig[] = [
  createBubbleStageConfig({
    ...
    targetPearls: 12,
    moveLimit: 30,
    starScoreThresholds: [1400, 2800, 4400],
    difficulty: 1,
    coinReward: 20,
    firstClearBonus: 30,
  }),
  createBubbleStageConfig({
    ...
    targetPearls: 16,
    moveLimit: 30,
    starScoreThresholds: [1900, 3600, 5600],
    difficulty: 1,
    coinReward: 22,
    firstClearBonus: 32,
  }),
  createBubbleStageConfig({
    ...
    targetPearls: 20,
    moveLimit: 30,
    starScoreThresholds: [2500, 4600, 7000],
    difficulty: 2,
    coinReward: 24,
    firstClearBonus: 36,
  ...
  createBubbleStageConfig({
    ...
    targetPearls: 24,
    moveLimit: 30,
    starScoreThresholds: [3100, 5600, 8400],
    difficulty: 2,
    coinReward: 26,
    firstClearBonus: 38,
    availablePowerups: ['x2_score'],
  ...
  createBubbleStageConfig({
    ...
    targetPearls: 28,
    moveLimit: 31,
    starScoreThresholds: [3800, 6800, 9800],
    difficulty: 3,
    coinReward: 28,
    firstClearBonus: 42,
    availablePowerups: ['x2_score'],
  ...
  createBubbleStageConfig({
    ...
    targetPearls: 32,
    moveLimit: 32,
    starScoreThresholds: [4500, 8000, 11600],
    difficulty: 3,
    coinReward: 30,
    firstClearBonus: 45,
    availablePowerups: ['x2_score'],
  ...
  createBubbleStageConfig({
    ...
    targetPearls: 36,
    moveLimit: 33,
    starScoreThresholds: [5300, 9200, 13200],
    difficulty: 4,
    coinReward: 32,
    firstClearBonus: 48,
  ...
  createBubbleStageConfig({
    ...
    targetPearls: 40,
    moveLimit: 34,
    starScoreThresholds: [6200, 10600, 15000],
    difficulty: 4,
    coinReward: 34,
    firstClearBonus: 50,
    availablePowerups: ['x2_score', 'bomb_item'],
  ...
  createBubbleStageConfig({
    ...
    targetPearls: 44,
    moveLimit: 35,
    starScoreThresholds: [7000, 12000, 17000],
    difficulty: 5,
    coinReward: 36,
    firstClearBonus: 54,
    availablePowerups: ['x2_score', 'bomb_item'],
  ...
  createBubbleStageConfig({
    ...
    targetPearls: 48,
    moveLimit: 36,
    starScoreThresholds: [7900, 13600, 19200],
    difficulty: 5,
    coinReward: 40,
    firstClearBonus: 60,
